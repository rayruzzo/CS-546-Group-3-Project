...
// Used by both create and update post forms
...
// Validate all fields
export function validateForm(fieldsToValidate) {
    let isValid = true;
...
export function initializeFormValidation(formId, fieldsToValidate) {
